...
package com.elham.sound_direction_detection_app.ui.kiko;
...
public class RecognizeSounds {
  ...
  public static class RecognitionResult {
    public final String foundSound;
    public final float score;
    public final boolean isNewSound;

    public RecognitionResult(String inFoundSound, float inScore, boolean inIsNewSound) {
      foundSound = inFoundSound;
      score = inScore;
      isNewSound = inIsNewSound;
    }
  }
  ...
  public RecognitionResult processLatestResults(float[] currentResults, long currentTimeMS) {
    ...
    return new RecognitionResult(currentTopLabel, currentTopScore, isNewSound);
  }
}
