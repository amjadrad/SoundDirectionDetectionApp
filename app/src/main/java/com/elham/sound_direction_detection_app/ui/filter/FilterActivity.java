package com.elham.sound_direction_detection_app.ui.filter;
...
import com.elham.sound_direction_detection_app.databinding.ActivityFilterBinding;
...
public class FilterActivity extends BaseActivity {
        ...
        binding.seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                if (progress != seekBarLastProgress1) {
                    ...
                    binding.textView2.setText(Integer.toString(progress + 2));
                }
            }
    ...
    public void filter(View view) {
        ...
        audioOutThread.filterOnOff((binding.toggleButton).isChecked());
...
//        int sampleRate = 70100;
        ...
        private final int minSize = AudioTrack.getMinBufferSize(sampleRate,
        ...
        public void initialize() {
            ...
            is = getResources().openRawResource(R.raw.test3);
